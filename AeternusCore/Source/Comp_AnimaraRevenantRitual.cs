...
{
    public class CompProperties_AnimaraRevenantRitual : CompProperties
    {
        public ThingDef circleDef;
        public string commandLabel = "Animate Echobound Revenant";
        public string commandDescription = "Begin an Animara rite to animate a corpse as an Echobound Revenant.";
        public string commandIconPath;
        public bool hideWhenCircleAbsent;

        public CompProperties_AnimaraRevenantRitual()
        {
            compClass = typeof(Comp_AnimaraRevenantRitual);
        }
    }

    public class Comp_AnimaraRevenantRitual : ThingComp
    {
        private CompProperties_AnimaraRevenantRitual Props => (CompProperties_AnimaraRevenantRitual)props;
        ...
        private bool TryFindRitualSetup(out Thing circle, out string failReason)
        {
            ...
            {
                failReason = "The Animara rite is missing its ritual center definition.";
                return false;
            }
            ...
            failReason = "Requires an orthogonally adjacent Animara ritual center.";
            return false;
        }
        ...
        private void TryStartRitualJobs(Pawn conductor, List<Pawn> audience, Corpse corpse, Thing circle)
        {
            ...
            Job job = JobMaker.MakeJob(DefDatabase<JobDef>.GetNamed("AF_PerformAnimaraRevenantRite"), corpse, parent, circle);
            job.count = 1;
